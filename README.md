...
- Open UTM:
 ...
 <img width="271" alt="image" src="https://github.com/malakalhanafi02/AI/assets/122760944/2424b7b3-e308-45cb-bbff-cd4a58a1c381">
  ...
  -> Follow the instructions (English -> Continue without updating -> keyboard configuration "done" -> Proxy (most home networks don't use a proxy) -> Mirror address (Dont change) "Done" -> Storage "use the entire disk" -> <img width="916" alt="image" src="https://github.com/malakalhanafi02/AI/assets/122760944/61b695e5-2413-4737-b1de-cb6b346a26d3"> "Continue"
  -> Set up Ubuntu profile -> Install OpenSSH or skip -> Now the installation starts!!
